...
public interface StatusUtilCompagnieTransportTransformer {
    ...
    StatusUtilCompagnieTransportDTO toDto(StatusUtilCompagnieTransport entity);

    @IterableMapping(qualifiedBy = {FullTransformerQualifier.class})
    List<StatusUtilCompagnieTransportDTO> toDtos(List<StatusUtilCompagnieTransport> entities) throws ParseException;

    public default StatusUtilCompagnieTransportDTO toLiteDto(StatusUtilCompagnieTransport entity) {
        if (entity == null) {
            return null;
        }
        StatusUtilCompagnieTransportDTO dto = new StatusUtilCompagnieTransportDTO();
        dto.setId( entity.getId() );
        dto.setStatusUtilId(entity.getStatusUtil()==null?null:entity.getStatusUtil().getId());
        dto.setCompagnieTransportId(entity.getCompagnieTransport()==null?null:entity.getCompagnieTransport().getId());
        return dto;
    }

    public default List<StatusUtilCompagnieTransportDTO> toLiteDtos(List<StatusUtilCompagnieTransport> entities) {
        if (entities == null || entities.stream().allMatch(o -> o == null)) {
            return null;
        }
        List<StatusUtilCompagnieTransportDTO> dtos = new ArrayList<StatusUtilCompagnieTransportDTO>();
    ...
    StatusUtilCompagnieTransport toEntity(StatusUtilCompagnieTransportDTO dto, CompagnieTransport compagnieTransport, StatusUtil statusUtil);
}
