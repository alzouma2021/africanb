...
public class VilleDTO {
    ...
    //realtionShip
    private Long paysId;
    private String paysDesignation;
    ...
    public String getPaysDesignation() {
        return paysDesignation;
    }
    public void setPaysDesignation(String paysDesignation) {
        this.paysDesignation = paysDesignation;
    }
